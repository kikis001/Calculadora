package com.example.postfija.dinamicos;

import fes.aragon.dinamicos.Nodo;

public class ListaSimple<E> {
    public fes.aragon.dinamicos.Nodo<E> cabeza;
    public fes.aragon.dinamicos.Nodo<E> cola;
    ...
    public ListaSimple(E valor) {
        cabeza = new fes.aragon.dinamicos.Nodo<>(valor);
        cola = cabeza;
        longitud = 1;
    }
    ...
    public ListaSimple<E> eliminarEnCola() {
        if(longitud == 0 ) {
            ...
            fes.aragon.dinamicos.Nodo<E> penultimo = currentIndex(longitud - 2);
            penultimo.next = null;
            cola = penultimo;
        }
        longitud--;
    ...
    public int estaEnLista(E x) {
        fes.aragon.dinamicos.Nodo<E> nodoActual = cabeza;
        int counter = 0;
    ...
    public ListaSimple<E> insertarEnCola(E value) {
        fes.aragon.dinamicos.Nodo<E> nuevoNodo = new fes.aragon.dinamicos.Nodo<>(value);
        if(longitud == 0) {
            cabeza = nuevoNodo;
            cola = nuevoNodo;
        }else {
    ...
    public ListaSimple<E> insertar(E value, int i) {
        ...
        fes.aragon.dinamicos.Nodo<E> nuevoNodo = new fes.aragon.dinamicos.Nodo<>(value);
        fes.aragon.dinamicos.Nodo<E> elementPre = currentIndex(i -1);
        fes.aragon.dinamicos.Nodo<E> sostenerPuntero = elementPre.next;
    ...
    public void asignar(E value, int i) {
        ...
        fes.aragon.dinamicos.Nodo<E> actualizar = currentIndex(i);
     ...
     */
    private fes.aragon.dinamicos.Nodo<E> currentIndex(int i) {
        if (i < 0 || i >= longitud) {
            throw new IndexOutOfBoundsException("Índice fuera de rango: " + i);
        }
        int contador = 0;
        fes.aragon.dinamicos.Nodo<E> actual = cabeza;
        while(contador != i) {
            actual = actual.next;
            contador++;
        }
    ...
    public ListaSimple<E> eliminarEnIndice(int i) {
        ...
        if(i == 0) {
            ...
            fes.aragon.dinamicos.Nodo<E> prev = currentIndex(i -1);
            fes.aragon.dinamicos.Nodo<E> remove = prev.next;
