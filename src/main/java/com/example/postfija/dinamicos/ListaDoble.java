...
public class ListaDoble<E>{
    public fes.aragon.dinamicos.NodoD<E> cabeza;
    public fes.aragon.dinamicos.NodoD<E> cola;
    ...
    public ListaDoble(E valor) {
        fes.aragon.dinamicos.NodoD<E> nuevoNodo = new fes.aragon.dinamicos.NodoD<>(valor);
        cabeza = nuevoNodo;
        cola = nuevoNodo;
        longitud = 1;
    }
    ...
    public int estaEnLista(E x){
        fes.aragon.dinamicos.NodoD<E> actual = cabeza;
        int contador = 0;
    ...
    public ListaDoble<E> eliminaEnIndice(int i) {
        ...
        fes.aragon.dinamicos.NodoD<E> prev = currentIndex(i-1);
        fes.aragon.dinamicos.NodoD<E> remove = prev.next;
    ...
    public ListaDoble<E> insertarEnIndice(E x, int i) {
        ...
        fes.aragon.dinamicos.NodoD<E> nuevoNodo = new fes.aragon.dinamicos.NodoD<>(x);
        fes.aragon.dinamicos.NodoD<E> elementoPrevio = currentIndex(i-1);
        fes.aragon.dinamicos.NodoD<E> sostenerPuntero = elementoPrevio.next;
    ...
    public ListaDoble<E> asignar(E x, int i) {
        ...
        fes.aragon.dinamicos.NodoD<E> actual = currentIndex(i);
        actual.valor = x;
        return this;
    }

    private fes.aragon.dinamicos.NodoD<E> currentIndex(int i) {
        if(i < 0 || i >= longitud) {
            throw new IndexOutOfBoundsException("Indice fuera de rango" + i);
        }
        fes.aragon.dinamicos.NodoD<E> actual;
        if(i < longitud / 2) {
            actual = cabeza;
            for(int j = 0; j < i; j++ ) {
                actual = actual.next;
